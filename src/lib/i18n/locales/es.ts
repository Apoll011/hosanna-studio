...
export const es: typeof pt = {
  ...
  settings: {
    ...
    notifications: {
      ...
      noAccessTitle: "No tiene permiso para enviar notificaciones",
      noAccessDesc:
        "Pida a un propietario de la organización el permiso de notificaciones para poder avisar a su equipo.",
      send: "Enviar notificación",
      sending: "Enviando...",
      sentToast: "¡Notificación enviada!",
      sentPushToast: "Notificación enviada — {count} push entregados.",
      genericError: "Error inesperado.",
      errorToast: "No se pudo enviar la notificación: {error}",
      summaryOrg:
        "Todos los miembros la recibirán en el buzón de la aplicación.",
      summaryOrgRoles:
        "Limitado a {roles} — entregado en el buzón de la aplicación.",
      summaryUser: "{name} recibirá esta notificación.",
      recipient: {
        title: "Destinatario",
        desc: "Elija quién recibe esta notificación.",
        user: "Usuario",
        userDesc: "Buscar y enviar a un miembro",
        organization: "Organización",
        organizationDesc: "Enviar a todos los miembros",
        searchPlaceholder: "Buscar miembros por nombre o email...",
        searching: "Buscando miembros...",
        noResults: "Ningún miembro coincide con su búsqueda.",
        clear: "Limpiar selección",
        lockedBadge: "Organización actual",
        lockedHint:
          "El ID de la organización está fijado a su espacio de trabajo activo y no se puede editar.",
        rolesFilter: "Limitar por rol",
        rolesFilterHint:
          "Sin roles seleccionados, se alcanza a todos los miembros.",
        everyone: "Todos los miembros",
        inboxOnly:
          "El envío a la organización solo llega al buzón de la aplicación — sin push.",
        loadError: "No se pudieron cargar los miembros.",
      },
      content: {
        title: "Mensaje",
        desc: "Lo que verán sus miembros.",
        typeLabel: "Tipo",
        types: {
          info: "Información",
          organization: "Organización",
        ...
        customTypePlaceholder: "ej.: anuncio",
        titleLabel: "Título",
        titlePlaceholder: "ej.: Ensayo movido a las 20:00",
        descriptionLabel: "Descripción",
        descriptionPlaceholder:
          "Detalles opcionales mostrados en el cuerpo de la notificación",
        linkLabel: "Enlace",
        linkPlaceholder: "/services",
        linkHint: "Enlace interno al tocar la notificación (opcional).",
        preview: "Vista previa",
        previewEmpty: "El título de la notificación aparecerá aquí.",
        now: "ahora",
        appName: "Hosanna Studio",
      },
      delivery: {
        title: "Canal de entrega",
        desc: "Cómo llega este aviso al dispositivo.",
        inbox: "Buzón",
        inboxDesc: "Solo en la aplicación",
        push: "Push",
        pushDesc: "Alerta Firebase en los dispositivos registrados",
        both: "Ambos",
        bothDesc: "Buzón + alerta Firebase",
        pushTitle: "Contenido del push",
        pushHint:
          "El push usa el mismo título y descripción del mensaje de arriba; el enlace se adjunta automáticamente como link.",
        dataLabel: "Datos extra",
        addRow: "Añadir campo",
        keyPlaceholder: "clave",
        valuePlaceholder: "valor",
        removeRow: "Quitar campo",
        dataHint:
          "Pares clave/valor entregados con el push (parámetros de enlace, etc.). Valores en texto.",
      },
    },
    billing: {
      title: "Facturación",
  ...
  agenda: {
    ...
    assigneesGetNotified:
      "Use «Notificar asignaciones» en los detalles del evento para avisar a quien aún no fue notificado.",
    type: "Tipo",
    location: "Ubicación",
    ...
    notifications: "Notificaciones",
    notify: {
      assignSection: "Asignaciones",
      assignBtn: "Notificar asignaciones",
      assignHint: "Solo envía a quien aún no fue notificado.",
      pending: {
      ...
      locationPending: "Ubicación cambiada — aún por notificar.",
      dateBtn: "Notificar cambio de fecha",
      locationBtn: "Notificar cambio de ubicación",
      bothBtn: "Notificar usuarios",
      bothHint: "Fecha y ubicación se envían en una sola notificación.",
      sentCount: {
        one: "1 notificación enviada",
        other: "{count} notificaciones enviadas",
      },
      sentPartial: "{sent} notificaciones enviadas, {failed} fallaron.",
      noRecipients: "No hay usuarios contactables para notificar.",
      sendError: "No se pudo notificar: {error}",
      noPermission: "No tiene permiso para enviar notificaciones.",
      atTime: "a las {time}",
      ...
      locationBody: "Nueva ubicación:\n{location}",
      updateTitle: "Los detalles de {event} han cambiado",
      updateBody: "Fecha:\n{date}\n\nUbicación:\n{location}",
      removeAssigneesTitle: "Eliminar asignaciones",
      removeAffected: {
        one: "Se eliminará {count} asignación.",
        other: "Se eliminarán {count} asignaciones.",
      },
      removeSummary: "A eliminar",
